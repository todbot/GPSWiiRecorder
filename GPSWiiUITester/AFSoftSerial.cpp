/*
  AFSofSerial.cpp - Software serial library
  Copyright (c) 2006 David A. Mellis.  All right reserved. - hacked by ladyada 

  mods added by tod:
  - made includes relative so this library can be used in-sketch
  x allow tuning of AFSS_MAX_RX_BUFF (this doesn't work, why not)
...
#include "AFSoftSerial.h"   // made relative so it can be included in-sketch

/******************************************************************************
 * Definitions
 ******************************************************************************/
//#ifndef AFSS_MAX_RX_BUFF   this doesn't work, why not? (also no work in .h)
